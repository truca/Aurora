...
class OperationsControllerTest < ActionController::TestCase
  ...
  test "should create operation" do
    assert_difference('Operation.count') do
      post :create, operation: { amount: @operation.amount, description: @operation.description, person: @operation.person, solved: @operation.solved }
    end
  ...
  test "should update operation" do
    patch :update, id: @operation, operation: { amount: @operation.amount, description: @operation.description, person: @operation.person, solved: @operation.solved }
    assert_redirected_to operation_path(assigns(:operation))
  end
